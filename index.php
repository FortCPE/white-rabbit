...
//mysql://b379b46b1d3faf:3fd19d7d@us-cdbr-iron-east-03.cleardb.net/heroku_765e6206795ae96?reconnect=true
 $accessToken = "CwYcqVS3XK9U+VHvq16CWDtVIJZq/xqLdASXGTBuLZ1uUTq54Y8SsqBlY2H0dEjW8Jz+ldrd6yf+rTRJMlXIt2OcBTTlOwKJpnpOXyzyOirRdbFzm+/KrBsNcj32qPnFYgYvq12yD2Jl9d2CLrLUAwdB04t89/1O/w1cDnyilFU=";//copy ข้อความ Channel access token ตอนที่ตั้งค่า
   ...
   }else if(strpos($message, "sec1") !== false || strpos($message, "sec 1") !== false){
      if(isset($arrayJson['events'][0]['source']['groupId'])){
         $id = $arrayJson['events'][0]['source']['groupId'];
         $arrayPostData['to'] = $id;
         $post = [
   ...
   }else if(strpos($message, "sec2") !== false || strpos($message, "sec 2") !== false){
      if(isset($arrayJson['events'][0]['source']['groupId'])){
         $id = $arrayJson['events'][0]['source']['groupId'];
         $arrayPostData['to'] = $id;
         $post = [
   ...
   }else if(strpos($message, "sec3") !== false || strpos($message, "sec 3") !== false){
      if(isset($arrayJson['events'][0]['source']['groupId'])){
         $id = $arrayJson['events'][0]['source']['groupId'];
         $arrayPostData['to'] = $id;
         $post = [
         ...
         $result = explode(":", $response);
         $arrayPostData['messages'][0]['type'] = "text";
         $arrayPostData['messages'][0]['text'] = "ยอดน้อง SEC 3 \n - ยอดน้องทั้งหมด ".$result[27]." คน \n - ยอดน้องลา ".$result[28]." คน \n - น้องคงเหลือ ".$result[29]." คน";
         $arrayPostData['messages'][1]['type'] = "text";
         $arrayPostData['messages'][1]['text'] = "ยอดน้องผู้ชายปัจจุบัน \n - น้องผู้ชายทั้งหมด ".$result[30]." คน \n - น้องผู้ชายลาทั้งหมด ".$result[31]." คน \n - น้องผู้ชายคงเหลือ ".$result[32]." คน";
         $arrayPostData['messages'][2]['type'] = "text";
   ...
   }else if(strpos($message, "sec4") !== false || strpos($message, "sec 4") !== false){
      if(isset($arrayJson['events'][0]['source']['groupId'])){
         $id = $arrayJson['events'][0]['source']['groupId'];
         $arrayPostData['to'] = $id;
         $post = [
         ...
         $result = explode(":", $response);
         $arrayPostData['messages'][0]['type'] = "text";
         $arrayPostData['messages'][0]['text'] = "ยอดน้อง SEC 4 \n - ยอดน้องทั้งหมด ".$result[36]." คน \n - ยอดน้องลา ".$result[37]." คน \n - น้องคงเหลือ ".$result[38]." คน";
         $arrayPostData['messages'][1]['type'] = "text";
         $arrayPostData['messages'][1]['text'] = "ยอดน้องผู้ชายปัจจุบัน \n - น้องผู้ชายทั้งหมด ".$result[39]." คน \n - น้องผู้ชายลาทั้งหมด ".$result[40]." คน \n - น้องผู้ชายคงเหลือ ".$result[41]." คน";
         $arrayPostData['messages'][2]['type'] = "text";
   ...
   }else if(strpos($message, "sec5") !== false || strpos($message, "sec 5") !== false){
      if(isset($arrayJson['events'][0]['source']['groupId'])){
         $id = $arrayJson['events'][0]['source']['groupId'];
         $arrayPostData['to'] = $id;
         $post = [
         ...
         $result = explode(":", $response);
         $arrayPostData['messages'][0]['type'] = "text";
         $arrayPostData['messages'][0]['text'] = "ยอดน้อง SEC 5 \n - ยอดน้องทั้งหมด ".$result[45]." คน \n - ยอดน้องลา ".$result[46]." คน \n - น้องคงเหลือ ".$result[47]." คน";
         $arrayPostData['messages'][1]['type'] = "text";
         $arrayPostData['messages'][1]['text'] = "ยอดน้องผู้ชายปัจจุบัน \n - น้องผู้ชายทั้งหมด ".$result[48]." คน \n - น้องผู้ชายลาทั้งหมด ".$result[49]." คน \n - น้องผู้ชายคงเหลือ ".$result[50]." คน";
         $arrayPostData['messages'][2]['type'] = "text";
         $arrayPostData['messages'][2]['text'] = "ยอดน้องผู้หญิงปัจจุบัน \n - น้องผู้หญิงทั้งหมด ".$result[51]." คน \n - น้องผู้หญิงลาทั้งหมด ".$result[52]." คน \n - น้องผู้หญิงคงเหลือ ".$result[53]." คน";
         replyMsg($arrayHeader,$arrayPostData);
      }else{
         $id = $arrayJson['events'][0]['source']['userId'];
         $arrayPostData['to'] = $id;
